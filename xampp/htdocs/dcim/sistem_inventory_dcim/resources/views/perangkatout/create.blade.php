...
<div>
        <form action="/perangkatout" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="tgl_keluar" id="tgl_keluar" placeholder="Masukan Tanggal Keluar" autocomplete="off">
                @error('tgl_keluar')
                    <div class="alert alert-danger">
                        {{ $message }}
                    </div>
                ...
                <input type="text" class="form-control" name="installer" id="installer" placeholder="Masukkan Nama Pemasang" autocomplete="off">
                @error('installer')
                    <div class="alert alert-danger">
                        {{ $message }}
                    </div>
